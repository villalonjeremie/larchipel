...
<a href="#">Store Locator</a>[/vc_column_text][/vc_column_inner][vc_column_inner column_width_percent="100" align_horizontal="align_right" style="dark" gutter_size="3" font_family="font-175345" overlay_alpha="50" medium_width="2" align_mobile="align_center_mobile" mobile_width="0" shift_x="0" shift_y="0" shift_y_down="0" z_index="0" width="1/4"][vc_icon display="inline" icon="fa fa-cc-visa" size="fa-2x"][/vc_icon][vc_icon display="inline" icon="fa fa-cc-mastercard" size="fa-2x"][/vc_icon][vc_icon display="inline" icon="fa fa-cc-paypal" size="fa-2x"][/vc_icon][vc_icon display="inline" icon="fa fa-cc-stripe" size="fa-2x"][/vc_icon][/vc_column_inner][/vc_row_inner][/vc_column][/vc_row]
';
